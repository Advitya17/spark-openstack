...
1. Spawn open-stack on cloudlab. Use Mitaka relase. (Other newer releases such as 'Stein' may not work as Stein doesn't support images added via a URL. Need to confirm for other OpenStack releases.)
